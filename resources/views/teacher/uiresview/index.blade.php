                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a class="btn  btn-warning " href="{{ URL::to('/teacher/uiresview/'.$entity['userid'].'/'.$entity['uitopicid']) }}">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a class="btn  btn-info " href="{{ URL::to('/teacher/uistudentres/'.$entity['userid'].'/'.$entity['id']) }}">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a class="btn  btn-danger " href="{{ URL::to('/teacher/uiuploadsrc/'.$entity['userid'].'/'.$entity['uitopicid'].'/'.$entity['id']) }}">
