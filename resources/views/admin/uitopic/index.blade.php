                            ...
                            <tbody>
      			            ...
      			            <td>{{ $entity['description'] }}</td>
                                    ...
                                    <td class="text-center">
                                        <form method="POST" action="{{ URL::to('/admin/uitopic/'.$entity['id']) }}">
                                            {{ csrf_field() }}
                                            <input type="hidden" name="_method" value="DELETE" />
                                            <div class="btn-group">
                                                <a class="btn btn-info" href="{{ URL::to('/admin/uitopic/'.$entity['id']) }}"><i class="fa fa-eye"></i></a>
                                                <a class="btn btn-success" href="{{ URL::to('/admin/uitopic/'.$entity['id'].'/edit') }}"><i class="fa fa-pencil-alt"></i></a>
