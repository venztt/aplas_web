...
<div class="row">
    <div class="col-12">
        {{ Form::open(['route'=>'exerciseconf.store', 'files'=>true]) }}
        <div class="card">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {{ Form::text('androidclass', '', ['class'=>'form-control', 'placeholder'=>'Enter Android test folder path']) }}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {{ Form::text('testpath', '', ['class'=>'form-control', 'placeholder'=>'Enter Android test folder path']) }}
                        </div>
                        <div class="form-group">
