    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">UI Validation Result of Learning Result</h3>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $entity->{'jumlah_submit'} }}</td>
                                        <td>{{ $entity->{'checkresult'} }}</td>
                                        <td>{{ $entity->{'checkstat'} }}</td>
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a class="btn  btn-warning " href="{{ URL::to('/admin/uiresview/'.$filter.'/'.$entity->{'id'}) }}"><i class="fa fa-eye"></i>&nbsp;History</a>
                                            </div>
                                        </td>
                                    </tr>
                                    @php($number++)
