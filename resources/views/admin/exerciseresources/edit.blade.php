...
<div class="row">
    <div class="col-12">
        {{ Form::model($data,['route'=>['exerciseresources.update',$data['id']], 'files'=>true,'method'=>'PUT']) }}
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Change Data of Exercise Resource</h3>
            </div>
            <div class="card-body">
                @if(!empty($errors->all()))
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('exercise', $items, $data['exercise'], ['class' => 'form-control']) !!}
                        </div>
                        <div class="form-group">
